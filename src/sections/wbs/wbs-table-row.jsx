...
export default function WbsTableRow({ row, selected, handleClick, onView, onEdit, onDelete }) {
  ...
  return (
    <>
      ...
      <Checkbox disableRipple checked={selected} onChange={(event) => handleClick(event, row.name)} />
        </TableCell>
